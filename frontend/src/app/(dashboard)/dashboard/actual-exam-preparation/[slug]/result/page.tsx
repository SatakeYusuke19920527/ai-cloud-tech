...
export default async function ActualExamResultPage({
  params,
  searchParams,
}: {
    ...
    <div className="space-y-6">
      ...
      <Card className="border border-border bg-card">
        <CardHeader>
          ...
          <CardDescription>誤答箇所を復習し、次のセットに備えましょう</CardDescription>
        </CardHeader>
        <CardContent>
          {incorrectDetails.length === 0 ? (
            <p className="text-sm text-muted-foreground">全問正解でした！次のセットに挑戦しましょう。</p>
          ) : (
