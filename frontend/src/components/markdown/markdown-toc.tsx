...
// import { Markdown as BaseMarkdown } from "./markdown"; // 今のコンポーネントを流用
...
//       },
//       {
//         rootMargin: "0px 0px -70% 0px", // 画面上部に来たらアクティブ扱い
//         threshold: 0.1,
//       }
//     );
...
//                   activeId === item.id ? "text-blue-700 font-semibold" : "text-blue-600"
//                 }`}
//               >
//                 {item.text}
//               </a>
