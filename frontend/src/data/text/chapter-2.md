...
たとえば，「車輪 part-of 自転車」の場合，自転車から車輪を取り除くと自転車ではなくなるが，車輪は車輪のままである。この関係は，「指 
part-of 太郎」と同様に，全体を文脈として部分の役割が決まる関係である。
...
オントロジー研究が進むにつれ、知識を記述することの難しさが明らかになり、次の二つの流れが生まれた。

一つは、**対象世界の知識をどのように記述すべきかを哲学的に厳密に考察する成果ですがある。

もう一つは、**効率を重視し、とにかくコンピュータに大量のデータを読み込ませ、自動的に処理することを目指す立場**である。

これらはそれぞれ、**ヘビーウェイトオントロジー（重量オントロジー）とライトウェイトオントロジー（軽量オントロジー）**に対応する。

**ヘビーウェイトオントロジー**では、構成要素や意味的関係の正当性について哲学的な考察が必要となるため、人手による作業が多くなり、時間とコストがかかる。
一般常識をすべて手動で取り込もうとする**Cycプロジェクト**はその代表例であり、1984年に開始されて以降、現在も継続している。

**ライトウェイトオントロジー**では、完全に正しいものでなくても「使える」ことを重視する。

そのため、構成要素の分類関係の正当性については深い哲学的考察を行わない傾向がある。

「コンピュータで概念間の関係性を自動で見つけよう」という取り組みと相性がよく、webデータを解析して知識を取り出す**ウェブマイニング**やビッグデータを解析して有用な知識を取り出す**データマイニング**で多用されている。

こうした研究は、セマンティックWeb（Webサイトが持つ意味をコンピュータ同士で処理を行わせるための技術）や、LOD(Linked Open Data: コンピュータ処理に適したデータを公開・共有するための技術)などの研究として展開されている。

### ワトソンと東ロボくん

IBMが開発した**ワトソン（Watson）**は、2011年にアメリカのクイズ番組に出演し人間に勝利したことで注目を集めた。

ワトソンは基本的に、**Question-Answering（質問応答）**という研究分野の成果ですが、ウィキペディアの情報をもとに**ライトウェイトオントロジー**を生成し、それを解答に使っている。

ただワトソンは、質問の意味を理解して解答しているのではなく、**質問に含まれるキーワードと関連しそうな答え**を高速に探索しているだけである。

Watsonは当初、医療診断への応用を想定して開発されたが、その後は、新しい料理のレシピを考える「シェフ・ワトソン」やコールセンター、人材マッチング、広告など幅広い分野に応用が拡大している。

日本では、「ロボットは東大に入れるか」というプロジェクトの一環として、人工知能「**東ロボくん**」の開発が2011年に始まり、2020年まで続けられた。
2016年の東大模試では高い偏差値を記録し、多くの私立大学に合格可能なレベルに達した。

一方で、当時のAIの限界として、理科における図や文章の深い理解が困難であったことや
古文・漢文に関する利用可能なデジタルデータが少なかったこと、数学で東大合格水準を超えることが難しいと判断されたこと

などが挙げられ、2016年を最後に全科目受験は中止され、各教科ごとの研究を深める段階へ移行した。