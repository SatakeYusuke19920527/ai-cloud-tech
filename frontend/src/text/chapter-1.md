...
その会議では、世界初の人工知能プログラムであるロジック・セオリストをデモンストレーションされ、コンピュータが数学の定理を自動的に証明可能であると示された。
...
自然言語処理の分野では、自然な文章を生成できる「大規模言語モデル（Large Language Model：LLM）」と呼ばれる技術が登場し、これを応用したさ
まざまなサービスが実用化された。
...
簡単にいえば、「今やろうとしていることに関係する情報だけを正しく選ぶのが、とても難しい」ということ。
